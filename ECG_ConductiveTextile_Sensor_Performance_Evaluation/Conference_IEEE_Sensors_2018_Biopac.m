...
%Ads1292rS32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Rama-ADS1292R\Rama-S52.csv');

%%Biopac mp36
%BiopacAgAgCl = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\Akashay-AgAgCl-Dormo-leadI-LIMB.mat');
%BiopacKJ32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\Akashay-KJ32-Lead-I-2000g-1000sps.mat');
%data1Biopac = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\Akashay-KJ52-Lead-I-5000g-1000sps.mat');
%BiopacS32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\Akashay-S32-Lead-I-5000g-1000sps.mat');
...
BiopacKJ32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\lead-I-RAM-KJ32.mat');
%data1Biopac = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\lead-I-RAM-KJ52.mat');
BiopacS32  = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\ttdbt\lead-I-RAM-Sil32.mat');
...
BiopacAgAgCl = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Biopac-ECG-Data-textile\ram-agagcl-6-min.mat');
%BiopacAgAgCl = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors-2018\Biopac-ECG-Data-textile\ramesh-agacl-6-min.mat');
%BiopacS32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Biopac-ECG-Data-textile\ram-s32-6-min.mat');
%BiopacAgAgCl = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Biopac-ECG-Data-textile\subject-1-agagcl-reference.mat');
%BiopacKJ32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Biopac-ECG-Data-textile\subject-1-kj32.mat');
%BiopacS32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Biopac-ECG-Data-textile\subject-1-s32.mat');
%BiopacS32 = load('F:\Rama-Reddy-R Textile material\Conference-IEEE-Sensors\Biopac-ECG-Data-textile\subject-1-s32-ii.mat');
...
DataR = BiopacAgAgCl.data;
DataS = BiopacS32.data;
DataKJ = BiopacKJ32.data;
...
sig1 = sig1(30*Fs1:300*Fs1);
sig2 = sig2(30*Fs1:300*Fs1);
sig3 = sig3(30*Fs1:300*Fs1);
...
plot(tr, sig1)
ylim([-2 2])
title('ECG Obtained from Ag/AgCl-electrode','FontName','times','FontSize',28,'LineWidth',2)
xlabel('Time(sec)','FontName','times','FontSize',28,'LineWidth',2)
ylabel('Amplitude(mV)','FontName','times','FontSize',28,'LineWidth',2)
subplot(3,1,2)
grid on
plot(ts, sig2)
ylim([-2 2])
title('ECG Obtained from Silver-electrode','FontName','times','FontSize',28,'LineWidth',2)
xlabel('Time(sec)','FontName','times','FontSize',28,'LineWidth',2)
ylabel('Amplitude(mV)','FontName','times','FontSize',28,'LineWidth',2)
subplot(3,1,3)
grid on
plot(tkj, sig3)
ylim([-2 2])
title('ECG Obtained from Knit-Jersey-electrode','FontName','times','FontSize',28,'LineWidth',2)
xlabel('Time(sec)','FontName','times','FontSize',28,'LineWidth',2)
ylabel('Amplitude(mV)','FontName','times','FontSize',28,'LineWidth',2)
% xlabel('Frequency (Hz)','FontName','times','FontSize',28,'LineWidth',2)	 	 
% ylabel('PSD (mV ^{2} dB/ Hz)','FontName','times','FontSize',28,'LineWidth',2);
% legend({'Ag/AgCl-Electrode','Silver-Electrode','Knit-Jersey-Electrode'},'FontName','times','FontSize',24)
set(gca,'FontSize',28, 'YLim', ([-1 1]),'LineWidth',2);
...
% k5 = kurtosis(Sdata5);
% k6 = kurtosis(Sdata6);
[Pxx1,f1] = pwelch(sig1,wlen,Noverlap,nfft,Fs1,SpectrumType);
[Pxx2,f2] = pwelch(sig2,wlen,Noverlap,nfft,Fs1,SpectrumType);
[Pxx3,f3] = pwelch(sig3,wlen,Noverlap,nfft,Fs1,SpectrumType);
...
plot(f1,Pxx1,'r','LineWidth',2);
hold on
% %plot(f2,10*log10(Pxx2),'g','LineWidth',1);
plot(f2,Pxx2,'g','LineWidth',2);
hold on
% xlabel('Frequency (Hz)')	 	 
% ylabel('PSD (mV ^{2} dB/ Hz)');
% figure(4)
plot(f3,Pxx3,'b','LineWidth',2);
hold on
...
RMSdata2 = rms(sig2);
RMSdata3 = rms(sig3);
ecgin1 = DataR(50*Fs1:110*Fs1);
ecgin2 = DataS(50*Fs1:110*Fs1);
ecgin3 = DataKJ(50*Fs1:110*Fs1);

tr1 =(0:length(ecgin1)-1)/Fs1;
ts1 =(0:length(ecgin2)-1)/Fs1;
tkj1 =(0:length(ecgin3)-1)/Fs1;


figure(15)
subplot(3,1,1)
grid on
plot(tr1, ecgin1,'r','LineWidth',2)
ylim([-2 2])
%title('ECG Obtained from Ag/AgCl-electrode')
xlabel('Time(sec)')
ylabel('Amplitude(mV)')
legend({'ECG-Ag/AgCl-electrode'},'FontName','times','FontSize',12)
set(gca,'FontName','times','FontSize',20, 'YLim', ([-1 1]),'LineWidth',2);
set(gca,'FontName','times','FontSize',20,'LineWidth',2);
subplot(3,1,2)
grid on
plot(ts1, ecgin2,'g','LineWidth',2)
%ylim([-2 2])
%title('ECG Obtained from Silver-electrode')
xlabel('Time(sec)')
ylabel('Amplitude(mV)')
legend({'ECG-Silver-electrode'},'FontName','times','FontSize',12)
set(gca,'FontName','times','FontSize',20, 'YLim', ([-1 1]),'LineWidth',2);
set(gca,'FontName','times','FontSize',20,'LineWidth',2);
subplot(3,1,3)
grid on
plot(tkj1, ecgin3,'b','LineWidth',2)
%ylim([-2 2])
%title('ECG Obtained from Knit-Jersey-electrode')
xlabel('Time(sec)')
ylabel('Amplitude(mV)')
legend({'ECG-Knit-Jersey-electrode'},'FontName','times','FontSize',12)
% xlabel('Frequency (Hz)','FontName','times','FontSize',28,'LineWidth',2)	 	 
% ylabel('PSD (mV ^{2} dB/ Hz)','FontName','times','FontSize',28,'LineWidth',2);
% legend({'Ag/AgCl-Electrode','Silver-Electrode','Knit-Jersey-Electrode'},'FontName','times','FontSize',24)
set(gca,'FontName','times','FontSize',20, 'YLim', ([-1 1]),'LineWidth',2);
...
for i=1
     figure(16);
     %title('Baseline wandering extraction during normal breath of a subject')
     xlabel('Time(sec)')
     ylabel('Baseline shift(mV)')
%      set(gca,'FontName','times','FontSize',18, 'YLim', ([-1 1]),'LineWidth',2);
%      set(gca,'FontName','times','FontSize',18,'LineWidth',2);
     hold on
     if(length(B1)<length(W1))
     plot(W1(1:length(B1)),B1,'r','LineWidth',2);  % splined baseline that was subtracted
     else
     plot(W1,B1(1:length(W1)),'r','LineWidth',2);  % splined baseline that was subtracted
     end
     hold on
     if(length(B2)<length(W2))
     plot(W2(1:length(B2)),B2,'g','LineWidth',2);  % splined baseline that was subtracted
     hold on
     else
     plot(W2,B2(1:length(W2)),'g','LineWidth',2);  % splined baseline that was subtracted
     end
     hold on
     if(length(B3)<length(W3))
     plot(W3(1:length(B3)),B3,'b','LineWidth',2);  % splined baseline that was subtracted
     hold on
     else
     plot(W3,B3(1:length(W3)),'b','LineWidth',2);  % splined baseline that was subtracted
     end
     set(gca,'FontName','times','FontSize',28, 'YLim', ([-0.5 0.5]),'LineWidth',2);
     set(gca,'FontName','times','FontSize',28,'LineWidth',2);
     legend({'ECG-Ag/AgCl-electrode','ECG-Silver-electrode','ECG-Knit-Jersey-electrode'},'FontName','times','FontSize',24)
 end
% for i=1
%     figure();
%     if(length(B3)<length(W3))
...
%     plot(W4(1:length(B4)),B4,'y');  % splined baseline that was subtracted
%     else
%     plot(W4,B4(1:length(W4)),'y');  % splined baseline that was subtracted
%     end
% end
% for i=1
%     figure();

...
s(1,:)=[s1 zeros(1,maxlength1-length(s1))];
s(2,:)=[s2 zeros(1,maxlength1-length(s2))];
...
a11=0.0021; a12=0.1562; a13=0.3452;
a21=0.4629; a22=0.5412; a23=0.6211;
a31=0.1256; a32=0.5789; a33=0.9237;
...
rp=0.03; rs=0.02; r=40;
fp=1500; fs=2400; Fs=10000;

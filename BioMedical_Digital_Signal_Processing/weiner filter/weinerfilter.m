clc;
clear all;
idealECG = load ('C:\Users\REDDY\Desktop\LAB EXPERIMENTS\weiner filter\ECG.DAT');
t = 1:length(idealECG);
...
title('Ideal ECG (IdealECG) and noisy ECG (observation)');
...
title('Ideal ECG (IdealECG) and filtered observation');
